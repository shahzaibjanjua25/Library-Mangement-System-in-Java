...
public class ReturnBook extends JFrame implements ActionListener{
	...
	lblBook.setFont(new Font("Times New Roman", Font.BOLD, 14));
	...
	lblDateOfIssue.setFont(new Font("Times New Roman", Font.BOLD, 14));
	...
	lblDateOfReturn.setFont(new Font("Times New Roman", Font.BOLD, 14));
